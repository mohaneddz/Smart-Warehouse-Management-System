...
function Navbar() {
 ...
 left-1/2 -translate-x-1/2 rounded-2xl bg-[#0A0B14] w-[40%] h-[4.873rem] border border-[#30383E]"
    >
      {/* 3D Layout */}
      <div
        onClick={() => {
      ...
      >
        <img
          className={`w-[70%] h-[70%] ${active === 'layout' ? 'opacity-100' : 'opacity-20'}`}
      ...
      <div
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 flex justify-center items-center rounded-full border border-[#30383E]
          w-[7.6875rem] h-[7.6875rem] sm:w-[6rem] sm:h-[6rem] md:w-[7.6875rem] md:h-[7.6875rem] lg:w-[8rem] lg:h-[8rem]
           bg-[#0A0B14] hover:bg-[#13141F] cursor-pointer"
      >
        <img
          src="/assets/svgs/Home.svg"
          alt="Home"
          className={`${active === 'home' ? 'opacity-100' : 'opacity-20'} w-[80%] h-[60%]`}
        />
      </div>
