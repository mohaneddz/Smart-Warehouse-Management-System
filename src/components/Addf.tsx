...
const SimpleForm = () => {
  ...
  // Function to update numeric fields
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const { name, value } = e.target;
    setFormData((prev) => ({
      ...prev,
      [name as keyof typeof formData]: Number(value),
    }));
  };
  ...
  const NumberInput = ({
    ...
    <div className="relative h-12 w-75 rounded-xl border border-gray-700 bg-gradient-to-r from-[#10121E] via-[#7F8387]/50 to-[#10121E]">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 p-4">
      ...
      <div className="grid grid-rows-2 justify-items-center gap-0 place-items-center">
        <div className="relative rounded-xl h-12 w-75 border border-gray-700 bg-gradient-to-r from-[#10121E] via-[#7F8387]/50 to-[#10121E]">
